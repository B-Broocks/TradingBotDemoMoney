...
- **Persistent State Management:** Saves the state of open positions to a local `bot_gedaechtnis.json` file every minute. This allows the bot to be stopped, restarted, or updated without losing track of active trades.
